...
public class vrp3 : MonoBehaviour {
    ...
    void Start()
    {
        ...
        goal = .
        GameObject.Find("Cube (2)").transform;
    ...
    void Update()
    {
        ...
        if (pos.x <= 20796 && pos.y >= 20914 && pos.z <= 41618) //está en el espacio apto para teletransportarse
        {
            agent.transform.position = new Vector3(20788, 20914, 42017);
        }
